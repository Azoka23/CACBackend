...
def create_usuario():
    data = request.json
    new_usuario = Usuario(apellido=data['apellido'], nombre=data['nombre'],
fecha_nacimiento=data['fecha_nacimiento'], documento=data['documento'], telefono=data['telefono'], email=data['email'], pais_origen=data['pais_origen'], password=data['password'])
    new_usuario.save()
